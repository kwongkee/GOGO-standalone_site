                ...
                key: "render", value: function (e, t) {
                    ...
                    var P = S("div", {class: "xm-toolbar"}, e.toolbar.list.map((function (t) {
                        ...
                        I = S("div", {class: h ? "xm-search" : "xm-search dis"}, S("i", {class: "xm-iconfont xm-icon-sousuo"}), S("input", {
                            class: "xm-input xm-search-input xm-search-origin",
                            placeholder: b
                        }));
                    //自定义样式2023-09-15
                    return A.length || A.push(S("div", {class: "xm-select-empty"}, r)),S("div", {
                        ...
                        onClick: function (e) {
                            document.getElementsByClassName('search1')[0].className = 'diy_search search1 active';
                            document.getElementsByClassName('search2')[0].className = 'diy_search search2';

                            document.getElementsByClassName("scroll-body")[0].style.display="block";
                            document.getElementsByClassName("xm-search-origin")[0].parentNode.style.display="block";
                            document.getElementsByClassName("diy-scroll-body")[0].style.display="none";
                            document.getElementsByClassName("xm-search-diy")[0].parentNode.style.display="none";
                        },
                        class: "diy_search search1 active",
                        dangerouslySetInnerHTML: {
                            __html: s({
                                data: 1,
                                item: 2,
                        ...
                        onClick: function (e) {
                            document.getElementsByClassName('search2')[0].className = 'diy_search search2 active';
                            document.getElementsByClassName('search1')[0].className = 'diy_search search1';

                            document.getElementsByClassName("scroll-body")[0].style.display="none";
                            document.getElementsByClassName("xm-search-origin")[0].parentNode.style.display="none";
                            document.getElementsByClassName("diy-scroll-body")[0].style.display="block";
                            document.getElementsByClassName("xm-search-diy")[0].parentNode.style.display="block";
                        },
                        class: "diy_search search2",
                        dangerouslySetInnerHTML: {
                            __html: s({
                                data: 1,
                                item: 2,
                        ...
                        class: "diy-scroll-body",
                        style: {maxHeight: 'fit-content',display:'none'},
                    },S("div", {class: h ? "xm-search" : "xm-search dis"}, S("i", {class: "xm-iconfont xm-icon-sousuo"}), S("input", {
                        class: "xm-input xm-search-input xm-search-diy",
                        placeholder: b,
                        onInput:function(msg){
                            let search = document.getElementsByClassName('xm-search-diy')[0].value;
                            var xhr = new XMLHttpRequest();
                            xhr.open('POST', '/collect_website/public/?s=admin/Basic/search_info&type=1&keywords=' + search,true);
                            ...
                            xhr.onreadystatechange = function() {
                                if (xhr.status == 200) {
                                    ...
                                    if(results.code==0 && results.list != ''){
                                        for(let i=0;i<results.list.length;i++){
                                            if(results.list[i].limit_product==1){
                                                //禁限物品属性
                                                html += '<div style="display:flex;align-items: center;justify-content: space-between;margin-bottom:5px;"><div class="xm-option-content" onclick="select_option(\''+results.list[i].name+'\','+results.list[i].id+')" style="color:#ff2222;width: 135px;overflow: hidden;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;word-break: break-all;white-space: break-spaces;">'+results.list[i].parent_name + '__' + results.list[i].name+'</div><div style="white-space:nowrap;margin-right:15px;padding:0px 8px;box-sizing: border-box;border:1px solid #000;border-radius:5px;font-size:12px;" onclick="openValue('+results.list[i].id+',1);">查看详情</div></div>';
                                            }else{
                                                html += '<div style="display:flex;align-items: center;justify-content: space-between;margin-bottom:5px;"><div class="xm-option-content" onclick="select_option(\''+results.list[i].name+'\','+results.list[i].id+')" style="width: 135px;overflow: hidden;display: -webkit-box;-webkit-line-clamp: 1;-webkit-box-orient: vertical;word-break: break-all;white-space: break-spaces;">'+results.list[i].parent_name + '__' + results.list[i].name+'</div><div style="white-space:nowrap;margin-right:15px;padding:0px 8px;box-sizing: border-box;border:1px solid #000;border-radius:5px;font-size:12px;" onclick="openValue('+results.list[i].id+',1);">查看详情</div></div>';
                                            }
                                        }
                                    ...
                                    document.getElementsByClassName('diy-search-content')[0].innerHTML=html;
                                }
                            };
                        ...
                        class: "diy-search-content",
                        style: {maxHeight: 'fit-content'},
                    })), this.state.loading && S("div", {class: "loading"}, S("span", {class: "loader"})))
                }
            }, {
                key: "componentDidMount", value: function () {
                    var e = this.base.querySelector(".xm-search-input");
