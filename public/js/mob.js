...
function(a, b) {
    ...
    function d(a, b) {
        ...
        e = function(a, b) {
            for (var c = []; b.length;) {
                var e, f = b.shift(),
                g = a.split("")[0];
                if ("#" === g) e = f.getElementById(a.replace(/^#/, "")),
                e && (e = [e]);
                else if ("." === g) e = d(f, a.replace(/^\./, "")),
                e && (e = [].slice.call(e));
                else {
                    e = [];
        ...
        f = function(a) {
            for (var b, d = []; a.length;) b = a.shift(),
            -1 === c(b, d) && d.push(b);
            return d
        },
    ...
    function k(a, b) {
        for (var c = 0,
        d = a.length; d > c; c++) b.call(a[c], c, a[c])
    }
    function m(b) {
        if (!b) return ! 1;
    ...
    function n(a) {
        for (var b = {},
        c = a.substr(a.indexOf("?") + 1).split("&"), d = 0, e = c.length; e > d; d++) {
            var f = c[d],
            g = f.split("=");
            b[g[0]] = g[1]
        }
    ...
    function o(a, c, d, e) {
        ...
        g = !1;
        f.onload = function() { ! g && d && d(!0, "success"),
            g = !0,
            f.parentNode.removeChild(f)
        },
        setTimeout(function() { ! g && d && d(!1, "timeout")
        },
        e),
        f.src = a + "?" + p(c),
    ...
    function v(a) {
        function c(a) {
            ...
            d = a.offsetParent; null !== d;) c += d.offsetLeft,
            d = d.offsetParent;
            var e;
        ...
        function d(a) {
            ...
            d = a.offsetParent; null !== d;) c += d.offsetTop,
            d = d.offsetParent;
            var e;
    ...
    function z(a, b) {
        if (!E.appkey) throw "not defined appkey";
        var c = "Normal";
    ...
    function B(c, d, e, g) {
        ...
        if (!h.appkey) throw "not defined appkey";
        var i = {
            m: D.encode(m(f(h, d)))
        };
    ...
    var D, E = {
        ...
        platforms: {
            ...
            linkedin: {
                id: 16,
                api: "http://www.linkedin.cn/shareArticle",
                handler: function(a) {
                    return {
                        title: a.title,
                        url: a.url,
    ...
    D = function() {
        ...
        e = {
            ...
            decode: function(d) {
                ...
                for (var s = "",
                h = 0,
                i = p.length; i > h; ++h) s += String.fromCharCode(p[h]);
                return s
            }
        };
        return e
    ...
    I = function() {
        ...
        g = function(a) {
            ...
            for (var d = null,
            e = 0,
            g = f.length; g > e; e++) if (f[e].text == this.options.text && f[e].text.correctLevel == this.options.correctLevel) {
                d = f[e].obj;
                break
            }
        ...
        c.prototype = {
            ...
            createQrcode: function() {
                ...
                d = 0; 8 > d; d++) {
                    this.makeImpl(d);
                    var e = j.getLostPoint(this); (0 == d || a > e) && (a = e, b = d, c = this.modules)
                }
                this.modules = c,
            ...
            createData: function() {
                ...
                for (var d = 0,
                f = this.utf8bytes.length; f > d; d++) a.put(this.utf8bytes[d], 8);
            ...
            createBytes: function(a) {
                ...
                g = new Array,
                h = 0; f > h; h++) for (var i = this.rsBlock[3 * h + 0], k = this.rsBlock[3 * h + 1], l = this.rsBlock[3 * h + 2], m = 0; i > m; m++) g.push([l, k]);
    ...
    M.ready = function() {
        ...
        var d = [],
        e = !1;
        return b.addEventListener ? (b.addEventListener("DOMContentLoaded", c, !1), b.addEventListener("readystatechange", c, !1), a.addEventListener("load", c, !1)) : b.attachEvent && (b.attachEvent("onreadystatechange", c), a.attachEvent("onload", c)),
        function(a) {
            e ? a.call(b) : d.push(a)
        }
    } (),
                ...
                for (n in f) {
                    ...
                    if (m = "function" == typeof f[n] ? f[n].call(b, n) : f[n], m = +parseFloat(m).toFixed(1) || 0, p = +q === k ? "": q.match(/(?:px|em|pt)/i), "transition" in b.style) {
                        ...
                        if (h(b, "transitionProperty") && (u = h(b, "transitionProperty").replace(/ /g, "").split(",")), l) t = m + p;
                            ...
                            z = y.match(/translate\(([^,]+),([^)]+)\)/);
                            z && (v = z[1], w = z[2]),
                            "top" === s ? (s = x("transform"), t = "translate(" + v + "," + (t - k) + p + ")") : "left" === s ? (s = x("transform"), t = "translate(" + (t - k) + p + "," + w + ")") : "bottom" === s ? (s = x("transform"), t = "translate(" + v + "," + -(t - k) + p + ")") : "right" === s ? (s = x("transform"), t = "translate(" + -(t - k) + p + "," + w + ")") : t += p
                        } - 1 === c(s, u) && u.push(s),
                        h(b, {
    ...
    a.mobShare = M,
    "function" == typeof a.define && (a.define.amd || a.define.cmd) && a.define("mob-share", [],
    function() {
        return M.ui.init(),
        M
    })
