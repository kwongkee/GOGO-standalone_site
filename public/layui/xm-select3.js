                ...
                key: "render", value: function (e, t) {
                    ...
                    if(e.tree.vaguaSearch==1){
                        return A.length || A.push(S("div", {class: "xm-select-empty"}, r)),S("div", {
                            ...
                            onClick: function (e) {
                                var this2 = document.getElementById(u.nowElement).parentNode;
                                this2.getElementsByClassName('search1')[0].className = 'diy_search search1 active';
                                this2.getElementsByClassName('search2')[0].className = 'diy_search search2';
    
                                this2.getElementsByClassName("scroll-body")[0].style.display="block";
                                this2.getElementsByClassName("xm-search-origin")[0].parentNode.style.display="block";
                                this2.getElementsByClassName("diy-scroll-body")[0].style.display="none";
                                this2.getElementsByClassName("xm-search-diy")[0].parentNode.style.display="none";
                            },
                            ...
                            onClick: function (e) {
                                var this2 = document.getElementById(u.nowElement).parentNode;
                                this2.getElementsByClassName('search2')[0].className = 'diy_search search2 active';
                                this2.getElementsByClassName('search1')[0].className = 'diy_search search1';
    
                                this2.getElementsByClassName("scroll-body")[0].style.display="none";
                                this2.getElementsByClassName("xm-search-origin")[0].parentNode.style.display="none";
                                this2.getElementsByClassName("diy-scroll-body")[0].style.display="block";
                                this2.getElementsByClassName("xm-search-diy")[0].parentNode.style.display="block";
                            },
                            ...
                            onInput:function(msg){
                                var this2 = document.getElementById(u.nowElement).parentNode;
                                let search = this2.getElementsByClassName('xm-search-diy')[0].value;
                                var xhr = new XMLHttpRequest();
                                xhr.open('POST', '/?s=gather/search_info&type=1&keywords=' + search,true);
                                ...
                                if(search!=''){
                                    ...
                                    this2.getElementsByClassName('diy-search-content')[0].innerHTML='';
                                }
                            }
                        })),S("div", {
